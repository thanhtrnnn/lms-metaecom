...
export const neutralTheme = {
  ...
  tokens: {
    ...
    "--color-background-surface": "light-dark(#ffffff, #241e16)",
    "--color-background-body": "light-dark(#f6f1e9, #17140f)",
    "--color-background-card": "light-dark(#ffffff, #201b14)",
    "--color-background-popover": "light-dark(#ffffff, #201b14)",
    "--color-background-muted": "light-dark(#efe7da, #1e1912)",
    "--color-accent": "light-dark(#e07b1a, #f7a94d)",
    "--color-accent-muted": "light-dark(#f7ecdd, #f7a94d24)",
    "--color-neutral": "light-dark(#3a2c1a0f, #FFFFFF1A)",
    ...
    "--color-text-primary": "light-dark(#1f1a14, #f5efe6)",
    "--color-text-secondary": "light-dark(#6b6152, #b8ae9d)",
    "--color-text-disabled": "light-dark(#a99e8b, #5c5346)",
    "--color-text-accent": "light-dark(#a8540f, #f7a94d)",
    ...
    "--color-icon-accent": "light-dark(#a8540f, #f7a94d)",
    "--color-icon-primary": "light-dark(#1f1a14, #f5efe6)",
    "--color-icon-secondary": "light-dark(#6b6152, #b8ae9d)",
    "--color-icon-disabled": "light-dark(#a99e8b, #5c5346)",
    ...
    "--color-border": "light-dark(#e7decf, #FFFFFF14)",
    "--color-border-emphasized": "light-dark(#d8cdba, #5c5346)",
    "--color-skeleton": "light-dark(#eae1d2, #5c5346)",
    "--color-shadow": "light-dark(#2a1e0f1A, #0000004D)",
    "--color-tint-hover": "light-dark(#3a2c1a, white)",
